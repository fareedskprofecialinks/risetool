  ...
  function FeatureGrid(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onMapPointerMove", function (olEvt) {
      ...
      features.forEach(function (feature) {
        var key = _kebabCase(_this.props.keyFunction(feature));
  ...
  _createClass(FeatureGrid, [{
    ...
    value: function render() {
      ...
      if (_isFunction(rowClassName)) {
        ...
        rowClassNameFn = function rowClassNameFn(record) {
          return "".concat(finalRowClassName, " ").concat(_this3._rowKeyClassNamePrefix).concat(_kebabCase(record.key));
        };
      }

      return React.createElement(_table["default"], _extends({
