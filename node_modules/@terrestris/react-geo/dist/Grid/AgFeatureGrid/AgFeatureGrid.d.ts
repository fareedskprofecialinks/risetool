...
interface BaseProps {
     ...
     */
    onRowSelectionChange?: (selectedRowsAfter: any[], selectedFeatures: OlFeature[], deselectedRows: any[], deselectedFeatures: OlFeature[], evt: SelectionChangedEvent) => void;
    /**
...
export declare class AgFeatureGrid extends React.Component<AgFeatureGridProps, AgFeatureGridState> {
     ...
     */
    initMapEventHandlers: (map: any) => void;
    /**
     ...
     * @param olEvt The ol event.
     */
    onMapSingleClick: (olEvt: any) => void;
    /**
     ...
     */
    getFeatureFromRowKey: (key: string) => any;
    /**
