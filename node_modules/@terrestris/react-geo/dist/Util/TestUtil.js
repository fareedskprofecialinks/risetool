...
_defineProperty(TestUtil, "mountComponent", function (Component, props, options) {
  return (0, _enzyme.mount)(React.createElement(Component, props), options);
});
...
_defineProperty(TestUtil, "simulatePointerEvent", function (_ref) {
  var map = _ref.map,
      ...
      x = _ref.x,
      y = _ref.y,
      opt_shiftKey = _ref.opt_shiftKey,
  ...
  var olEvt = (0, _MapBrowserPointerEvent["default"])(type, map, event, dragging);
