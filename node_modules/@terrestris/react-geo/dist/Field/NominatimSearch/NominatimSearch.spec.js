...
describe('<NominatimSearch />', function () {
  ...
  describe('#doSearch', function () {
    it('sends a request with appropriate parts', function () {
      ...
      var expectations = [wrapper.props().nominatimBaseUrl, encodeURIComponent(wrapper.props().format), encodeURIComponent(wrapper.props().viewbox), encodeURIComponent(wrapper.props().bounded), encodeURIComponent(wrapper.props().polygon_geojson), encodeURIComponent(wrapper.props().addressdetails), encodeURIComponent(wrapper.props().limit), encodeURIComponent(wrapper.props().countrycodes), encodeURIComponent(inputValue)];
