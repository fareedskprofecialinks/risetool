...
function isVisibleComponent(WrappedComponent) {
  ...
  function (_React$Component) {
    ...
    function VisibleComponent() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(VisibleComponent)).call.apply(_getPrototypeOf2, [this].concat(args)));

      _defineProperty(_assertThisInitialized(_this), "isVisibleComponent", function (componentName) {
    ...
    _createClass(VisibleComponent, [{
      ...
      value: function render() {
        ...
        var _this$props = this.props,
            activeModules = _this$props.activeModules,
            passThroughProps = _objectWithoutProperties(_this$props, ["activeModules"]); // Check if the current component should be visible or not.


        var isVisible = this.isVisibleComponent(this.props.name); // Inject props into the wrapped component. These are usually state
        // values or instance methods.

        return isVisible ? React.createElement(WrappedComponent, passThroughProps) : null;
      }
    }]);
