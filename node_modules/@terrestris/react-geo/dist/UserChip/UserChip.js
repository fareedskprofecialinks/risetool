...
function (_React$Component) {
  ...
  function UserChip(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_className", "".concat(_constants.CSS_PREFIX, "userchip"));
  ...
  _createClass(UserChip, [{
    ...
    value: function getUserMenu() {
      var _this$props = this.props,
          ...
          passThroughProps = _objectWithoutProperties(_this$props, ["className", "imageSrc", "userMenu", "userName", "style"]);

      var finalClassName = className ? "".concat(className, " ").concat(this._className) : this._className;
      return React.createElement("div", {
        className: finalClassName,
        style: style
      }, React.createElement(_avatar["default"], _extends({
        src: imageSrc,
        size: "large",
        className: "userimage"
      }, passThroughProps), imageSrc ? '' : this.getInitials()), React.createElement("span", {
        className: "username"
      }, userName));
    }
    /**
      ...
      if (userMenu && React.isValidElement(userMenu)) {
        return React.createElement(_dropdown["default"], {
          ...
          getPopupContainer: function getPopupContainer() {
            return document.getElementsByClassName(_this2._className)[0];
          }
        }, this.getUserMenu());
      } else {
