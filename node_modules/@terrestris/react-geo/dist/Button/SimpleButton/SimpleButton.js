...
function (_React$Component) {
  ...
  function SimpleButton() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SimpleButton)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(SimpleButton, [{
    ...
    value: function render() {
      ...
      }, antBtnProps), icon || fontIcon ? React.createElement(_Icon["default"], {
        name: icon ? icon : '',
        className: fontIcon
