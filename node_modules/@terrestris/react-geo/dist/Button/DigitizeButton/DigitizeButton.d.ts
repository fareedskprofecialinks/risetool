...
declare class DigitizeButton extends React.Component<DigitizeButtonProps, DigitizeButtonState> {
     ...
     */
    static DEFAULT_POINT_STYLE: any;
    /**
     * Default style for digitized lines.
     */
    static DEFAULT_LINESTRING_STYLE: any;
    /**
     * Default style for digitized polygons or circles.
     */
    static DEFAULT_POLYGON_STYLE: any;
    /**
     * Default style for digitized labels.
     */
    static DEFAULT_TEXT_STYLE: any;
    /**
     ...
     */
    getDigitizeStyleFunction: (feature: any) => any;
    /**
     ...
     * @return The style to use.
     */
    getSelectedStyleFunction: (feature: any, res: number, text: string | number) => any;
    /**
     ...
     */
    createDrawInteraction: (pressed: any) => void;
    /**
     ...
     */
    createSelectOrModifyInteraction: () => void;
    /**
     ...
     */
    setTextOnFeature: (feat: any, onModalOkCbk: (feat: any, label: string) => void) => void;
    /**
